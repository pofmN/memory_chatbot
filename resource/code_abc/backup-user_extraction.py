...
"""
    ...
    def _save_node(self, state: UserInfoState) -> dict:
        ...
        try:
            ...
            # Merge with current profile (validated_info takes precedence)
            merged_info = {**current_profile, **validated_info}
            
            # Save to database
            success = self.db.update_user_profile(merged_info)
    ...
    def get_current_profile(self) -> dict:
        ...
        try:
            return self.db.get_user_profile() or {}
        except Exception as e:
...
if __name__ == "__main__":
    print("🚀 Testing User Information Extraction Agent")
    print("=" * 60)
    ...
    # Test cases
    test_inputs = [
        "my name is Pham Van Nam, i was born in 2003, now i'm a student in DaNang and intern at HBG company",
        "you can call me at 0123456789",
        "I just moved to Ho Chi Minh City, please update my address",
        "I'm studying Computer Science at university",
        "My phone number changed to 0987654321, and I also got a new job at Tech Corp"
    ]
    ...
    for i, test_input in enumerate(test_inputs, 1):
        ...
        print(f"👤 Current Profile: {agent.get_formatted_profile()}")
        print("-" * 50)
